...
if("FALSE" STREQUAL "TRUE")
  set(youbot_arm_kinematics_moveit_SOURCE_PREFIX /home/lucas/catkin_ws/src/youbot/youbot_manipulation/youbot_arm_kinematics_moveit)
  set(youbot_arm_kinematics_moveit_DEVEL_PREFIX /home/lucas/catkin_ws/devel)
  ...
  set(youbot_arm_kinematics_moveit_INSTALL_PREFIX /home/lucas/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'youbot_arm_kinematics_moveit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT youbot_arm_kinematics_moveit_NUM_DUMMY_TARGETS)
      set(youbot_arm_kinematics_moveit_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::youbot_arm_kinematics_moveit::wrapped-linker-option${youbot_arm_kinematics_moveit_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR youbot_arm_kinematics_moveit_NUM_DUMMY_TARGETS "${youbot_arm_kinematics_moveit_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::youbot_arm_kinematics_moveit::wrapped-linker-option${youbot_arm_kinematics_moveit_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND youbot_arm_kinematics_moveit_LIBRARIES "${interface_target_name}")
